...
namespace Acumatica.Default_17_200_001.Model
{
    ...
    public partial class SalesOrdersDiscountDetails : Entity,  IEquatable<SalesOrdersDiscountDetails>, IValidatableObject
    {
        ...
        public SalesOrdersDiscountDetails(DecimalValue discountableAmount = default(DecimalValue), DecimalValue discountableQty = default(DecimalValue), DecimalValue discountAmount = default(DecimalValue), StringValue discountCode = default(StringValue), DecimalValue discountPercent = default(DecimalValue), StringValue freeItem = default(StringValue), DecimalValue freeItemQty = default(DecimalValue), BooleanValue manualDiscount = default(BooleanValue), StringValue sequenceID = default(StringValue), BooleanValue skipDiscount = default(BooleanValue), StringValue type = default(StringValue), Guid? id = default(Guid?), long? rowNumber = default(long?), string note = default(string), Dictionary<string, Dictionary<string, CustomField>> custom = default(Dictionary<string, Dictionary<string, CustomField>>), List<FileLink> files = default(List<FileLink>)) : base(id, rowNumber, note, custom, files)
        {
