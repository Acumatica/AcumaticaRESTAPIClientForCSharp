...
namespace Acumatica.Default_26_200_001.Model
{
	...
	public class SalesOrderDetail : Entity
	{
		...
		public StringSingleSelectValue? LineType { get; set; }
		...
		public static class Expand
		{
			...
			public const string PurchasingDetails = "PurchasingDetails";

			//Intentionally excluded
			//public const string All = "Files,Allocations,PurchasingDetails";
		}
	}
}