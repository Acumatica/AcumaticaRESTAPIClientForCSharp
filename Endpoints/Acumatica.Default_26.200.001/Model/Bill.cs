...
namespace Acumatica.Default_26_200_001.Model
{
	...
	public class Bill : Entity, ITopLevelEntity
	{
		...
		[DataMember(Name="RetainageDocuments", EmitDefaultValue=false)]
		...
		public static class Expand
		{
			...
			public const string RetainageDocuments_Files = "RetainageDocuments/Files";
			public const string TaxDetails = "TaxDetails";
			public const string TaxDetails_Files = "TaxDetails/Files";

			//Intentionally excluded
			//public const string All = "Files,Translations,Applications,Applications/Files,Details,Details/Files,RetainageDocuments,RetainageDocuments/Files,TaxDetails,TaxDetails/Files";
		}
