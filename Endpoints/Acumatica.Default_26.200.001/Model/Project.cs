...
namespace Acumatica.Default_26_200_001.Model
{
	...
	public class Project : Entity, ITopLevelEntity
	{
		...
		public StringValue? ParentProjectID { get; set; }
		...
		[DataMember(Name="TagTemplate", EmitDefaultValue=false)]
		public StringValue? TagTemplate { get; set; }
		...
		public static class Expand
		{
			...
			//public const string All = "Files,Translations,ActivityHistory,ApprovalDetails,Attributes,Balances,BillingAndAllocationSettings,BillToSettings,Employees,Equipments,GLAccounts,Invoices,ProjectProperties,UnionLocals,VisibilitySettings,Retainage,ProjectAddress";
		}
