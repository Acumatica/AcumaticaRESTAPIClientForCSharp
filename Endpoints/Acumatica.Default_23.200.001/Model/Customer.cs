...
namespace Acumatica.Default_23_200_001.Model
{
	...
	public class Customer : Entity, ITopLevelEntity
	{
		...
		public static class Expand
		{
			...
			public const string All = "Attributes,BillingContact,BillingContact/Activities,BillingContact/Address,BillingContact/Attributes,BillingContact/Campaigns,BillingContact/Cases,BillingContact/Duplicates,BillingContact/MarketingLists,BillingContact/Notifications,BillingContact/Opportunities,BillingContact/Relations,BillingContact/RoleAssignments,BillingContact/UserInfo,BillingContact/UserInfo/Roles,Contacts,CreditVerificationRules,MainContact,MainContact/Activities,MainContact/Address,MainContact/Attributes,MainContact/Campaigns,MainContact/Cases,MainContact/Duplicates,MainContact/MarketingLists,MainContact/Notifications,MainContact/Opportunities,MainContact/Relations,MainContact/RoleAssignments,MainContact/UserInfo,MainContact/UserInfo/Roles,PaymentInstructions,PrimaryContact,PrimaryContact/Activities,PrimaryContact/Address,PrimaryContact/Attributes,PrimaryContact/Campaigns,PrimaryContact/Cases,PrimaryContact/Duplicates,PrimaryContact/MarketingLists,PrimaryContact/Notifications,PrimaryContact/Opportunities,PrimaryContact/Relations,PrimaryContact/RoleAssignments,PrimaryContact/UserInfo,PrimaryContact/UserInfo/Roles,Salespersons,ShippingContact,ShippingContact/Activities,ShippingContact/Address,ShippingContact/Attributes,ShippingContact/Campaigns,ShippingContact/Cases,ShippingContact/Duplicates,ShippingContact/MarketingLists,ShippingContact/Notifications,ShippingContact/Opportunities,ShippingContact/Relations,ShippingContact/RoleAssignments,ShippingContact/UserInfo,ShippingContact/UserInfo/Roles";
		}
