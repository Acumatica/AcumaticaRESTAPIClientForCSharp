...
namespace Acumatica.ISVCB_23_200_001.Model
{
	...
	public class ISVSolution : Entity, ITopLevelEntity
	{
		...
		public StringValue? CurrentRevision { get; set; }

		[DataMember(Name="PublishedonMarketplace", EmitDefaultValue=false)]
		public BooleanValue? PublishedonMarketplace { get; set; }
