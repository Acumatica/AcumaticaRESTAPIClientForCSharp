...
namespace Acumatica.ISVCB_23_200_001.Model
{
	...
	public class EducatedResourcesDetail : Entity
	{
		...
		[DataMember(Name="BadgeCreatedDate", EmitDefaultValue=false)]
		public DateTimeValue? BadgeCreatedDate { get; set; }
		...
		public IntValue? ContractID { get; set; }

		[DataMember(Name="ContractDetail_contractDetailID", EmitDefaultValue=false)]
		public IntValue? ContractDetail_contractDetailID { get; set; }

		[DataMember(Name="ContractItemID", EmitDefaultValue=false)]
		public IntValue? ContractItemID { get; set; }

		[DataMember(Name="PreviousStatus", EmitDefaultValue=false)]
		public StringValue? PreviousStatus { get; set; }
