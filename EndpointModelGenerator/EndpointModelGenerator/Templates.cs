namespace EndpointSchemaGenerator
{
	public static class Templates
	{
		...
		public static string ModelNamespace = $"{BaseNamespace}.Model";
		public static string ApiNamespace = $"{BaseNamespace}.Api";
        ...
        public static string ActionUsingsTemplate = UsingModelNamespace + "\r\nusing System.Runtime.Serialization;\r\n\r\n";
		...
		public static string EntityUsingsTemplate = UsingModelNamespace + "\r\nusing System.Collections.Generic;\r\nusing System.Runtime.Serialization;";
		...
		//{1} = ActionName
		//{2} = Content
		public static string ActionParametersTemplate = UsingModelNamespace + "\r\nusing Newtonsoft.Json;\r\nusing System.Runtime.Serialization;\r\n\r\nnamespace {0}.Model\r\n{{\r\n\t[DataContract]\r\n\tpublic class {1}Parameters\r\n\t{{\r\n\t\tpublic {1}Parameters() {{ }}\r\n{2}\r\n\t\tpublic virtual string ToJson()\r\n\t\t{{\r\n\t\t\treturn JsonConvert.SerializeObject(this, Formatting.Indented);\r\n\t\t}}\r\n\t}}\r\n}}";
