...
namespace Acumatica.RESTClient.Api
{
        ...
        where EntityType : Entity
    {
        ...
        protected async Task<ApiResponse<Dictionary<string, string>>> PutFileWithHttpInfoAsync(IEnumerable<string> ids, string filename, byte[] content)
        {
        ...
        /// <returns>Task of ApiResponse</returns>
        protected async Task<ApiResponse<Dictionary<string, string>>> InvokeActionWithHttpInfoAsync(EntityAction<EntityType> action)
        {
        ...
        protected async Task<int> GetProcessStatusWithHttpInfoAsync(string locationRaw)
        {
            if (locationRaw == null)
        ...
        /// <param name="custom">The fields that are not defined in the contract of the endpoint to be returned from the system. (optional)</param>
        /// <returns>Task of ApiResponse (Entity)</returns>
        protected async Task<ApiResponse<EntityType>> PutEntityWithHttpInfoAsync(EntityType entity, 
            string select = null, string filter = null, string expand = null, string custom = null, 
            PutMethod method = PutMethod.Any, DateTime? businessDate = null, string branch=null)
		{
			// verify the required parameter 'entity' is set
		...
		/// <param name="custom">The fields that are not defined in the contract of the endpoint to be returned from the system. (optional)</param>
		/// <returns>Task of ApiResponse (Entity)</returns>
		protected async Task<ApiResponse<EntityType>> GetByKeysWithHttpInfoAsync(IEnumerable<string> ids, string select = null, string filter = null, string expand = null, string custom = null)
        {
            // verify the required parameter 'ids' is set
            if (ids == null)
        ...
        protected async Task<ApiResponse<List<EntityType>>> GetListWithHttpInfoAsync(string select = null, string filter = null, string expand = null, string custom = null, int? skip = null, int? top = null)
        {
            var localVarPath = GetEndpointPath() + "/" + GetEntityName();
        ...
        /// <param name="custom">The fields that are not defined in the contract of the endpoint to be returned from the system. (optional)</param>
        /// <returns>Task of ApiResponse (Entity)</returns>
        protected async Task<ApiResponse<EntityType>> GetByIdWithHttpInfoAsync(Guid? id, string select = null, string filter = null, string expand = null, string custom = null)
        {
		...
		/// <exception cref="ApiException">Thrown when fails to make API call</exception>
		/// <returns>Task of ApiResponse (Entity)</returns>
		protected async Task<ApiResponse<EntityType>> GetAdHocSchemaWithHttpInfoAsync()
        {
		...
		/// <param name="ids">The values of the key fields of the record.</param>
		/// <returns>Task of ApiResponse</returns>
		protected async Task<ApiResponse<Dictionary<string, string>>> DeleteByKeysWithHttpInfoAsync(IEnumerable<string> ids)
        {
            // verify the required parameter 'ids' is set
            if (ids == null)
        ...
        /// <param name="id">The session ID of the record.</param>
        /// <returns>Task of ApiResponse</returns>
        protected async Task<ApiResponse<Dictionary<string, string>>> DeleteByIdWithHttpInfoAsync(Guid? id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
